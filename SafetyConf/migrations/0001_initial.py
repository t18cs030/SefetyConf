# Generated by Django 2.1.1 on 2021-01-15 06:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='employee',
            name='group',
            field=models.ManyToManyField(to='SafetyConf.Group'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='answer',
            name='emergencyContact',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SafetyConf.EmergencyContact'),
        ),
        migrations.AddField(
            model_name='answer',
            name='employee',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SafetyConf.Employee'),
        ),
    ]
